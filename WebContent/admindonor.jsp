...
<head>
  <title>Donor of Blood Donation System</title>
        ...
        <table border="" style="width:600px">
            ...
            <tr>
                ...
                <td> <%= resultset.getString(8) %></td>
           		<td> <a href="editDonorForm.jsp?id=<%=resultset.getInt(10) %>">Edit</a> 
           			<a href="deleteDonor.jsp?id=<%=resultset.getInt(10)%>">Delete</a>	
           		</td>     
