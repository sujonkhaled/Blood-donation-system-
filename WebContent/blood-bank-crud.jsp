...
<head>
  <title>Report of Blood  Donation System</title>
      ...
      <div id="content">
        ...
        <table border="" style="width:600px">
            ...
            <tr>
                ...
                <td> <a href="bloodBankEditForm.jsp?id=<%= resultset.getString(1) %>">Edit</a> </td>
                <td> <a href="deleteBankBlood.jsp?id=<%= resultset.getString(1)%>">Delete</a> </td>
