...
<head>
  <title>Registration of Blood  Donation System</title>
...
<body>
  <div id="main">
    <div id="header">
      <div id="logo">
        <div id="logo_text">
          ...
          <h1><a href="bindex.jsp">Blood  Donation <span class="logo_colour">System</span></a></h1>
    ...
    <div id="footer">
	<p>Copyright &copy; The Matrix | <a href="bindex.jsp">Blood  Donation System</a></p>
    </div>
  </div>
</body>
</html>
